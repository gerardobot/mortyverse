package com.minroud.mortyverse.feature.characters.ui.screens.detail.components
...
private fun episodesText(count: Int) =
    when {
...
@Composable
private fun CharacterBioPreview() {
